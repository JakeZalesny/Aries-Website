...
import Merchlist from './components/MerchList.svelte';
...
const productCard = document.getElementById('merch-list');
...
if (localStorage.getItem('dark-mode') === 'true') {
  ...
  productCard.classList.remove('dark-mode');
...
toggleButton.addEventListener('click', () => {
  ...
  productCard.classList.toggle('dark-mode');
...
new Merchlist({
  target: document.getElementById('merch-list')
});
